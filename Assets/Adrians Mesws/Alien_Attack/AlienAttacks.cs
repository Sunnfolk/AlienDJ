...
public class AlienAttacks : MonoBehaviour
{
    ...
    [SerializeField]
    private Vector3 gravity = new Vector3(0.2f, 0,0);
    [SerializeField]
    private float velocityMultiplyer = 0.5f;

    [HideInInspector] //Flying Objects use this to calculate their flight path
